			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form role="form" id="updateForm">
				  ...
				  <button type="button" id="restBtn" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</form>
			  </div>
			</div>
        </div>
        ...
        <script type="text/javascript">
            $(function () {
	            ...
	            $("#insertBtn").click(function(){
	            	...
	            	if(loginacct.val() == "" || username.val() == "" || email.val() == ""){
	            		layer.msg("请输入用户账号信息", {time:1000, icon:5, shift:6});
